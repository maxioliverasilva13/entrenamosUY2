...
<html>
    ...
    <body>
        ...
        <div class="flex">
            <div  class=" w-full h-full bg-cover bg-no-repeat border-none flex-1 bg-center md:relative md:blur-none blur-sm absolute z-0 " style="background-image: url('https://res.cloudinary.com/dwh8j7fys/image/upload/v1665238283/gym_j5mokj.png'); width: 100%; height: 100vh;">
            </div>
            ...
            <div class="flex-1 flex flex-col justify-center items-center mt-5">
                ...
                <div class="bg-[#4A4747] z-50 md:w-auto w-3/4 py-7 px-5 md:py-12 md:px-8 mt-5 rounded-[20px]">
