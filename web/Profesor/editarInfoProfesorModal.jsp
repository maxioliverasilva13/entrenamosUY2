...
<!DOCTYPE html>
<div id="editarInfoProfeModal" style="display: none;" class="w-screen h-screen fixed top-0 left-0 right-0 bottom-0 bg-[#6B7280] bg-opacity-60 flex fixed items-center justify-center transition-all">
