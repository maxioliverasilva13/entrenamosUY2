 ...
 */
@WebFilter(filterName = "ActividadSitio", urlPatterns = {"/*"})
public class ActividadSitio implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (requestUrl.matches(".*(css|jpg|png|gif|js)")) {
            return;
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ActividadSitio:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("ActividadSitio:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("ActividadSitio()");
        }
        StringBuffer sb = new StringBuffer("ActividadSitio(");
